...
admin.site.register(Hw1_submit)
admin.site.register(Hw1_key)

admin.site.register(Hw2_submit)
admin.site.register(Hw2_key)

admin.site.register(Hw3_submit)
admin.site.register(Hw3_key)
...
admin.site.register(Hw6_submit)
admin.site.register(Hw6_key)
